...
nav input { /* 검색어 */
	border-color: #565656;
	background-image: url("<%=request.getContextPath()%>/image/search.jpg");
...
<body>
	...
	<div class="top" align="right">
		<ul>
			...
			%>
			<li><a class="newlogin"
				href="<%=request.getContextPath()%>/mypage.jsp?id=<%=user.getUserId()%>"><font
					color="#8ca86e"><%=user.getUserName()%>님</font> <font
					color="#5d5d5d">마이페이지</font></a></li>
			...
			%>
			<li><a class="newlogin"
				href="<%=request.getContextPath()%>/register.jsp">회원가입</a></li>
			<li><a href="<%=request.getContextPath()%>/login.jsp">로그인</a></li>
			<%
			}
			%>
			<li><a href="<%=request.getContextPath()%>'여기에 고객센터 넣어주세요.jsps'">고객센터</a></li>
		</ul>
	...
	<div align="center" class="logo">
		<a href="<%=request.getContextPath()%>/main.jsp"><img
			src="<%=request.getContextPath()%>/image/mama.png" width=400
			height=150></a>
	</div>
	<br>
		...
		<ul class="main1">
			<li style="border: none;"><a href="#"><b
				...
				<ul class="main2">
					...
					%>
					<%--     <li><a href="<%=request.getContextPath() %>/outCategory.jsp?code1=<%=cb.getCode1()%>"><img width="30px" height="30px" src="<%=request.getContextPath()%>/image/<%=cb.getCode1()%>.png">&nbsp;&nbsp;<%=cb.getCname() %></a> --%>
<!-- 					<ul class="main3"> -->
<%-- 						<% --%>
...
<%-- 						%> --%>
<!-- 						<li><a -->
<%-- 							href="<%=request.getContextPath()%>/guest/inCategory.jsp?code1=<%=cb2.getCode1()%>&code2=<%=cb2.getCode2()%>"><%=cb2.getCname()%></a></li> --%>
<%-- 						<% --%>
// 						// }//CategoryBean2
<%-- 						%> --%>
<!-- 					</ul></li> -->
...
// 			} //CategoryBean
		...
		%>
		<li><a
			href="<%=request.getContextPath()%>/mainmenu.jsp?pspec=<%=menubar[i]%>"><%=menubar[i]%></a></li>
		<%
		}
		%>
		<li><a href="<%=request.getContextPath()%>/coupon.jsp">특가 /
				혜택</a></li>
		<li style="margin-left: 50px; padding-bottom: 0;"><a
			href="javascript:ClickCartList()"><img width="35px" height="35px"
				src="<%=request.getContextPath()%>/image/cart.png"></a></li>
		</ul>
	</div>
