 ...
 * Generated at: 2023-01-10 07:52:06 UTC
...
public final class main_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("}\n");
      out.write("#carousel_section{\n");
      out.write("    width: 100%;\n");
      out.write("    background-color: gray;\n");
      out.write("}\n");
      out.write("#carousel_section > ul{\n");
      out.write("    margin: 0px;\n");
      ...
      out.write("}\n");
      out.write("#carousel_section > ul > li{\n");
      out.write("    list-style: none;\n");
      out.write("    width: 100%;\n");
      out.write("    height: 100%;\n");
      out.write("    position: absolute;\n");
      out.write("}\n");
      out.write("#carousel_section > ul > li >img{\n");
      out.write("    list-style: none;\n");
      out.write("    width: 100%;\n");
      out.write("    height: 100%;\n");
      ...
      out.write("<script>\n");
      out.write("var time; // 슬라이드 넘어가는 시간\n");
      out.write("var $carouselLi;\n");
      out.write("var carouselCount; // 캐러셀 사진 갯수\n");
      out.write("var currentIndex; // 현재 보여지는 슬라이드 인덱스 값\n");
      out.write("var caInterval;\n");
      out.write(" \n");
      out.write("//사진 연결\n");
      out.write("var imgW; // 사진 한장의 너비    \n");
      out.write("$(document).ready(function(){\n");
      out.write(" \n");
      out.write("    carouselInit(350, 4000);\n");
      out.write("});\n");
      out.write(" \n");
      out.write("$(window).resize(function(){\n");
      out.write("    carousel_setImgPosition();\n");
      out.write("});\n");
      out.write(" \n");
      out.write("/* 초기 설정 */\n");
      out.write("function carouselInit( height, t ){\n");
      out.write("    /*\n");
      out.write("     * height : 캐러셀 높이\n");
      out.write("     * t : 사진 전환 간격 \n");
      out.write("    */\n");
      out.write(" \n");
      out.write("    time = t;\n");
      out.write("    $(\"#carousel_section\").height(height); // 캐너셀 높이 설정\n");
      out.write("    $carouselLi = $(\"#carousel_section > ul >li\");\n");
      out.write("    carouselCount = $carouselLi.length; // 캐러셀 사진 갯수\n");
      out.write("    currentIndex = 0; // 현재 보여지는 슬라이드 인덱스 값\n");
      out.write("    carousel_setImgPosition();\n");
      out.write("    carousel();\n");
      out.write("}\n");
      out.write(" \n");
      out.write("function carousel_setImgPosition(){\n");
      out.write(" \n");
      out.write("    imgW = $carouselLi.width(); // 사진 한장의 너비    \n");
      out.write("    // 이미지 위치 조정\n");
      out.write("    for(var i = 0; i < carouselCount; i++)\n");
      out.write("    {\n");
      out.write("        if( i == currentIndex)\n");
      out.write("        {\n");
      out.write("            $carouselLi.eq(i).css(\"left\", 0);\n");
      out.write("        }\n");
      out.write("        else\n");
      out.write("        {\n");
      out.write("            $carouselLi.eq(i).css(\"left\", imgW);\n");
      out.write("        }\n");
      out.write("    }\n");
      out.write("}\n");
      out.write(" \n");
      ...
      out.write(" \n");
      out.write("    // 사진 넘기기\n");
      out.write("    // 사진 하나가 넘어간 후 다시 꼬리에 붙어야함\n");
      out.write("    // 화면에 보이는 슬라이드만 보이기\n");
      out.write("    caInterval = setInterval(function(){\n");
      out.write("        var left = \"-\" + imgW;\n");
      out.write(" \n");
      out.write("        //현재 슬라이드를 왼쪽으로 이동 ( 마이너스 지점 )\n");
      out.write("        $carouselLi.eq(currentIndex).animate( { left: left }, function(){\n");
      out.write("            // 다시 오른쪽 (제자리)로 이동\n");
      out.write("            $carouselLi.eq(currentIndex).css(\"left\", imgW);\n");
      out.write(" \n");
      out.write("            if( currentIndex == ( carouselCount - 1 ) )\n");
      out.write("            {\n");
      ...
      out.write("        } );\n");
      out.write(" \n");
      out.write("        // 다음 슬라이드 화면으로\n");
      out.write("        if( currentIndex == ( carouselCount - 1 ) )\n");
      out.write("        {\n");
      out.write("            // 마지막 슬라이드가 넘어갈땐 처음 슬라이드가 보이도록\n");
      out.write("            $carouselLi.eq(0).animate( { left: 0 } );\n");
      out.write("        }\n");
      out.write("        else\n");
      out.write("        {\n");
      out.write("            $carouselLi.eq(currentIndex + 1).animate( { left: 0 } );\n");
      out.write("        }\n");
      out.write("    }, time);\n");
      out.write("}\n");
      out.write("$carouselLi.eq(currentIndex).animate( { left: left }, function(){\n");
	...
	System.out.println(mb);
      ...
      out.write("\n");
      out.write("<body>\n");
      out.write("	<div id=\"carousel_section\">\n");
      out.write("		<ul>\n");
      out.write("			<li> <img src=\"./images/1.png\"> </li>\n");
      out.write("			<li> <img src=\"./images/2.png\"> </li>\n");
      out.write("			<li> <img src=\"./images/3.png\"> </li>\n");
      out.write("			<li> <img src=\"./images/4.png\"> </li>\n");
      out.write("		</ul>\n");
      out.write("	</div>\n");
      out.write("</body>\n");
      out.write("</html>\n");
