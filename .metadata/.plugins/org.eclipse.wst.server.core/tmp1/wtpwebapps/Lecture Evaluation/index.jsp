...
<!--  부트스트랩 css 추가하기 -->
<link rel="stylesheet" href="./css/bootstrap.min.css?ver1">
<!--  커스텀 css 추가하기 -->
...
<body>
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<div id="navbar" class="collapse navbar-collapse">
			...
			<form action="form-inline my-2 my-lg-0">
				<input class="mr-sm-2" type="search" placeholder="내용을 입력하세요."
					aria-label="Search">
	...
	<section class="container">
		<form method="get" action="./index.jsp" class="form-inline mt-3">
			<select name="leecturDivide" class="form-control mx-1 mt-2">
	...
	<div class="card bg-light mt-3">
		<div class="card-header bg-ligth">
			<div class="row">
				<div class="col-8 text-left">컴퓨터개론&nbsp;<small>윤희재</small></div>
	...
	<div class="card bg-light mt-3">
		<div class="card-header bg-ligth">
			<div class="row">
				<div class="col-8 text-left">컴퓨터구조&nbsp;<small>서재원</small></div>
				<div class="col-4 text-right">
		...
		<div class="card-body">
			<h5 class="card-title">
				흥미로운 강의입니다.&nbsp;<small>(2017년 여름학기)</small>	
			</h5>
			<p class="card-text">학점도 잘 나오고 재밌습니다.</p>
			...
			<div class="row">
				<div class="col-9 text-left">
					...
					널널 <span style="color: red;"> A</span>
					강의 <span style="color: red;"> B</span>
					<span style="color: green;">(추천: 9)</span>
				</div>
				<div class="col-3 text-right">
					<a onclick="return confirm('추천하시겠습니까?')" href="./likeAction.jsp?evaluationID=">추천</a>
					<a onclick="return confirm('삭제하시겠습니까?')" href="./deleteAction.jsp?evaluationID=">삭제</a>
		...
		<div class="card-header bg-ligth">
			<div class="row">
				<div class="col-8 text-left">컴퓨터그래픽스&nbsp;<small>남호용</small></div>
				<div class="col-4 text-right">
					종합<span style="color: red;"> B</span>
				</div>
			</div>
		...
		<div class="card-body">
			<h5 class="card-title">
				나쁘지 않았습니다.&nbsp;<small>(2017년 여름학기)</small>	
			</h5>
			<p class="card-text">처음 배워봤지만,나름 흥미로웠습니다다.</p>
	...
	<footer class="bg-dark mt-4 p-5 text-center" style="color: #FFFFFF";>
		Copyright &copy; 2022 윤희재 All Rights Reserved.
	</footer>
	<!-- 제이쿼리 자바스크립트 추가하기 -->
