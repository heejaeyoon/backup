...
public class LoginApplication {
    ...
    public static void start(String[] args) {
        ...
        do {
            System.out.println("포인트를 적립하실려면 가입해주세요:) ");
            System.out.println("1.회원가입 2.로그인하여 나의 정보보기 3.포인트조회 4.탈퇴 5.가입 안하기");
            System.out.print("선택 > ");
    ...
    private static void lookAccount() {    //사용자조회 선택
    	...
    	for (User users : user) {
            if (users.getNickname() != null)
            	System.out.println(users.getNickname()+ "님의 적립된 총 포인트는 =" +"5000"+ "입니다.");
