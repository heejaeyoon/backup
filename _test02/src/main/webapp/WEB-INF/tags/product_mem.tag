...
<ul>
	...
	<li class="nav-item px-2"><a class="nav-link" aria-current="page"
		href="control.jsp?action=logout"> 로그아웃</a></li>
</ul>
<div class="dropdown d-none d-lg-block">
	<button class="btn bg-soft-warning ms-2" id="dropdownMenuButton1"
	...
	<div class="dropdown-menu dropdown-menu-lg-end p-0 rounded"
		...
		<form action="control.jsp" method="post">
			<input type="hidden" name="action" value="search"> <input
				class="form-control border-200" name="search" type="search"
				placeholder="Search" aria-label="Search"
				style="background: #FDF1DF;" />
		</form>
	</div>
</div>
<a class="btn btn-primary order-1 order-lg-0 ms-lg-3" href="myPage.jsp">
	마이페이지</a>
<a class="btn btn-primary order-1 order-lg-0 ms-lg-3"
	href="control.jsp?action=basket"> 장바구니</a>
<%
}
%>
